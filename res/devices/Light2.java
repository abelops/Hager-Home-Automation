...
public class Light2 extends Functioner {
    ...
    public Light2() {
        ...
        designer.headerCreator("Light-2", header, headerPanel); // designing the header and creating the header
